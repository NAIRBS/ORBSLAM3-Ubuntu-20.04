...
def generate_launch_description():
    ...
    return LaunchDescription([
        Node(
            ...
            output='screen',
            parameters=[
                {'left_camera_url': 'http://192.168.123.123'},
                {'right_camera_url': 'http://192.168.123.91'},
                {'calibration_file': '/home/nairb/colcon_ws/src/stereo_camera_pipeline/config/stereo_calibration.yaml'}
            ],
        ),
